  ...
  setTimeout(() => {
    ...
    document.getElementById("submitBox").onclick = function() {
      ...
      if (skibidiFort){
        ...
        iconCell.innerHTML = `<div style="border:none;min-width:5.208vw;" >   <img  id="editBox${newRowIndex}" src="editRowIcon.png"> <img  id="deleteBox${newRowIndex}" src="deleteRowIcon.png"> </div>` ;
